            ...
            <tbody>
                <tr v-for="(row) in sortedData">
                    ...
                    <td v-for="(value, key) in row" v-if="key!='supports'" :class="key">
                        ...
                        <div v-if="key=='name'" class="flex middle">
                            <div class="icon">
    ...
    data() {
        return {
            tableData: {
                tbody: [
                    {
                        ranking: '01', name: 'Woo network', price: 118.00, oneDay: '+2.32', sevenDays: '-4.12', start: 'Mar, 2022', market: 28, volume: 16, circ: 54, weight: 11, 
                        supports: {icon: 'https://s2.coinmarketcap.com/static/img/coins/200x200/7501.png', ticker: 'WOO'}
                    },
                    {
                        ranking: '02', name: 'Anchor Crypto', price: 203.00, oneDay: '+2.32', sevenDays: '-4.12', start: 'Feb, 2022', market: 28, volume: 16, circ: 54, weight: 11, 
